...
#define COCOAPODS_VERSION_MAJOR_BAPersistentOperationQueue 0
#define COCOAPODS_VERSION_MINOR_BAPersistentOperationQueue 1
#define COCOAPODS_VERSION_PATCH_BAPersistentOperationQueue 0
